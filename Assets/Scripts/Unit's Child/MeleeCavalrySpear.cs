...
public class MeleeCavalrySpear : Unit
{
    [SerializeField] private int moveRange = 6;
    [SerializeField] private int health = 110;
    [SerializeField] private int attack = 16;
    [SerializeField] private int defense = 9;

    private int currentHealth;

    public override string UnitName => "Melee Cavalry Spear";
    ...
    protected override TerrainEffect GetTerrainEffect(TerrainType terrainType)
    {
        switch (terrainType)
        {
            case TerrainType.Plain:
                return new TerrainEffect(0f, 0f, false); // Không còn MoveSpeedModifier
